...
function Ni(b) {
  ...
  for (var e = function() {
            ...
            for (var a = d;;) {
              if (a = M(a)) {
                if (Cd(a)) {
                  ...
                  return b ? te(e.ba(), x(ac(a))) : te(e.ba(), null);
                }
                b = N(a);
                e = T(b, 0);
                b = T(b, 1);
                if (2 < b) {
                  return R(new U(null, 2, 5, V, [e, b], null), x(Ec(a)));
                }
                a = Ec(a);
              } else {
                return null;
    ...
    if (k > a) {
      throw Li([E("Number of recursions ["), E(k), E("] exceeded while calculating column widths")].join(""));
    }
