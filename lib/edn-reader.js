...
h.call = function() {
  function b(a, b, c, d, e, f, g, k, l, m, n, p, q, u, v, y, w, C, A, H, O, aa) {
    a = this;
    var Ea = G.l(a.i, b, c, d, e, K([f, g, k, l, m, n, p, q, u, v, y, w, C, A, H, O, aa], 0)), Ji = Y(this, Ea);
    x(Ji) || X(a.name, Ea);
    return G.l(Ji, b, c, d, e, K([f, g, k, l, m, n, p, q, u, v, y, w, C, A, H, O, aa], 0));
  }
  function a(a, b, c, d, e, f, g, k, l, m, n, p, q, u, v, y, w, C, A, H, O) {
    a = this;
...
function Ni(b, a) {
  return null == a ? wi(b) : x(!0 === a || !1 === a) ? xi(b, a) : "string" === typeof a ? yi(b, a) : x(!1) ? zi(b, a) : a instanceof qc ? Ai(b, a) : a instanceof z ? Bi(b, a) : "number" === typeof a ? Ci(b, a) : Dd(a) ? Di(b, a) : wd(a) ? Ei(b, a) : (null != a ? a.j & 67108864 || a.td || (a.j ? 0 : B(Gb, a)) : B(Gb, a)) ? Mi(b, a) : vd(a) ? Fi(b, a) : td(a) ? Gi(b, a) : x(a instanceof xh) ? Hi(b, a) : x(!1) ? Ki(b, a) : a instanceof RegExp ? Li(b, a) : vi(b, a);
}
function Oi(b, a) {
  var c = od(a);
...
function Tk(b) {
  ...
  return pe.l(new U(null, 1, 5, V, [[E("Last Saved Values ("), E(Ej(Wf(a))), E(")")].join("")], null), Sk(a), K([new U(null, 1, 5, V, [R("Previous Values", Le(function() {
    return function(a, b) {
      return ef(new U(null, 1, 5, V, ["" + E(a)], null), Sk(b));
    };
  }(b, a, c), c))], null)], 0));
}
              ...
              if (a) {
                if (zd(a)) {
                  ...
                  a: {
                    for (var n = 0;;) {
                      if (n < l) {
                        var p = I.a(c, n), q = T(p, 0), p = T(p, 1), q = new U(null, 2, 5, V, [q, Tk(p)], null);
                        m.add(q);
                        n += 1;
                      } else {
                        c = !0;
                ...
                m = T(c, 0);
                c = T(c, 1);
                return R(new U(null, 2, 5, V, [m, Tk(c)], null), e(Cc(a)));
              }
              return null;
            }
          };
