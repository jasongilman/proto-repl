...
return proto_repl.edn_reader.display.execute_code.call(null,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Symbol("proto","def-by-id","proto/def-by-id",1690726392,null)),cljs.core._conj.call(null,cljs.core.List.EMPTY,id),cljs.core._conj.call(null,cljs.core.List.EMPTY,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Symbol(null,"quote","quote",1377916282,null)),cljs.core._conj.call(null,cljs.core.List.EMPTY,var_name)))))))));
})], null);
});
 ...
 * tree of values.
 */
proto_repl.edn_reader.display.value_map__GT_display_tree_values = (function proto_repl$edn_reader$display$value_map__GT_display_tree_values(p__10287){
var map__10298 = p__10287;
...
var id = cljs.core.get.call(null,map__10298__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var values = cljs.core.get.call(null,map__10298__$1,new cljs.core.Keyword(null,"values","values",372645556));
var iter__8816__auto__ = ((function (map__10298,map__10298__$1,id,values){
return (function proto_repl$edn_reader$display$value_map__GT_display_tree_values_$_iter__10300(s__10301){
return (new cljs.core.LazySeq(null,((function (map__10298,map__10298__$1,id,values){
return (function (){
var s__10301__$1 = s__10301;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__10301__$1);
if(temp__4657__auto__){
var s__10301__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__10301__$2)){
var c__8814__auto__ = cljs.core.chunk_first.call(null,s__10301__$2);
var size__8815__auto__ = cljs.core.count.call(null,c__8814__auto__);
var b__10303 = cljs.core.chunk_buffer.call(null,size__8815__auto__);
if((function (){var i__10302 = (0);
while(true){
if((i__10302 < size__8815__auto__)){
var vec__10306 = cljs.core._nth.call(null,c__8814__auto__,i__10302);
var var_name = cljs.core.nth.call(null,vec__10306,(0),null);
var value = cljs.core.nth.call(null,vec__10306,(1),null);
var val_display_tree = proto_repl.edn_reader.display.to_display_tree_STAR_.call(null,value);
cljs.core.chunk_append.call(null,b__10303,cljs.core.assoc_in.call(null,cljs.core.update_in.call(null,val_display_tree,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (i__10302,val_display_tree,vec__10306,var_name,value,c__8814__auto__,size__8815__auto__,b__10303,s__10301__$2,temp__4657__auto__,map__10298,map__10298__$1,id,values){
return (function (p1__10286_SHARP_){
return [cljs.core.str(var_name),cljs.core.str(": "),cljs.core.str(p1__10286_SHARP_)].join('');
});})(i__10302,val_display_tree,vec__10306,var_name,value,c__8814__auto__,size__8815__auto__,b__10303,s__10301__$2,temp__4657__auto__,map__10298,map__10298__$1,id,values))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10303),proto_repl$edn_reader$display$value_map__GT_display_tree_values_$_iter__10300.call(null,cljs.core.chunk_rest.call(null,s__10301__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10303),null);
}
} else {
var vec__10307 = cljs.core.first.call(null,s__10301__$2);
var var_name = cljs.core.nth.call(null,vec__10307,(0),null);
var value = cljs.core.nth.call(null,vec__10307,(1),null);
var val_display_tree = proto_repl.edn_reader.display.to_display_tree_STAR_.call(null,value);
return cljs.core.cons.call(null,cljs.core.assoc_in.call(null,cljs.core.update_in.call(null,val_display_tree,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (val_display_tree,vec__10307,var_name,value,s__10301__$2,temp__4657__auto__,map__10298,map__10298__$1,id,values){
return (function (p1__10286_SHARP_){
return [cljs.core.str(var_name),cljs.core.str(": "),cljs.core.str(p1__10286_SHARP_)].join('');
});})(val_display_tree,vec__10307,var_name,value,s__10301__$2,temp__4657__auto__,map__10298,map__10298__$1,id,values))
),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),proto_repl.edn_reader.display.def_button.call(null,id,var_name)),proto_repl$edn_reader$display$value_map__GT_display_tree_values_$_iter__10300.call(null,cljs.core.rest.call(null,s__10301__$2)));
}
} else {
return null;
}
...
});})(map__10298,map__10298__$1,id,values))
,null,null));
});})(map__10298,map__10298__$1,id,values))
;
...
var vec__10310 = saved_value_set;
var first_map = cljs.core.nth.call(null,vec__10310,(0),null);
var others = cljs.core.nthnext.call(null,vec__10310,(1));
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Saved values",cljs.core.PersistentArrayMap.EMPTY], null),proto_repl.edn_reader.display.value_map__GT_display_tree_values.call(null,first_map),cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Previous Values",cljs.core.PersistentArrayMap.EMPTY], null),cljs.core.map_indexed.call(null,((function (vec__10310,first_map,others){
...
var vec__10312 = temp__4655__auto__;
var header = cljs.core.nth.call(null,vec__10312,(0),null);
var rows = cljs.core.nthnext.call(null,vec__10312,(1));
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str("  "),cljs.core.str(header)].join(''),cljs.core.PersistentArrayMap.EMPTY], null),cljs.core.map.call(null,((function (vec__10312,header,rows,temp__4655__auto__){
...
});})(vec__10312,header,rows,temp__4655__auto__))
