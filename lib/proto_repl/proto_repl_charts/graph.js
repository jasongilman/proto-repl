...
var len__7755__auto___14107 = arguments.length;
var i__7756__auto___14108 = (0);
while(true){
if((i__7756__auto___14108 < len__7755__auto___14107)){
args__7762__auto__.push((arguments[i__7756__auto___14108]));

var G__14109 = (i__7756__auto___14108 + (1));
i__7756__auto___14108 = G__14109;
continue;
} else {
}
break;
...
return proto_repl_charts.graph.error.cljs$core$IFn$_invoke$arity$variadic(argseq__7763__auto__);
});
...
proto_repl_charts.graph.error.cljs$lang$applyTo = (function (seq14106){
return proto_repl_charts.graph.error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14106));
});
...
return cljs.core.mapv.call(null,(function (p1__14110_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"label","label",1718410804)],[p1__14110_SHARP_,p1__14110_SHARP_]);
}),nodes);
}
});
/**
...
return cljs.core.mapv.call(null,(function (p1__14111_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"from","from",1815293044),new cljs.core.Keyword(null,"to","to",192099007)],[cljs.core.first.call(null,p1__14111_SHARP_),cljs.core.second.call(null,p1__14111_SHARP_)]);
}),edges);
} else {
...
var nodes = cljs.core.get.call(null,map__14114__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var edges = cljs.core.get.call(null,map__14114__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
